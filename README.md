...
## 📌 Descripción del proyecto (para GitHub)

**Montecarlo sobre Montecarlo** es una simulación estadística de máquinas tipo *pick-one* (tragamonedas simplificadas) donde se analiza, mediante métodos de Monte Carlo anidados, cuál es el número óptimo de repeticiones que maximiza la ganancia promedio observada.
El proyecto combina probabilidad, simulación estocástica y *multiprocessing* en Python para estudiar cómo emergen estrategias óptimas desde el ruido aleatorio.
